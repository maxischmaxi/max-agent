...
#define COMMAND_COMPACT  "compact"
...
typedef enum {
    ...
    CMD_SETTINGS,
    CMD_COMPACT, /* verlauf manuell in eine summary verdichten */
...
static const Command COMMANDS[] = {
    ...
    [CMD_COMPACT] = {COMMAND_COMPACT,
                     "summarize older history into a compact summary"},
};
